...
// router
//     .route("/parties")
//     .post(cache.invalidate(), (req, res) => partyController.create(req, res));

// // GetAll
// router
//     .route("/parties")
//     .get(cache.route(), (req, res) => partyController.getAll(req, res));

// // GetById
// router
//     .route("/parties/:title")
//     .get(cache.route(), (req, res) => partyController.get(req, res));

// // Delete
// router
//     .route("/parties/:id")
//     .delete(cache.invalidate(), (req, res) => partyController.delete(req, res));

// // Update
// router
//     .route("/parties/:id")
//     .put(cache.invalidate(), (req, res) => partyController.update(req, res));
